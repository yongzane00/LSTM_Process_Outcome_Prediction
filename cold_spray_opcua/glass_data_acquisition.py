...
model.load_state_dict(torch.load("../trained_model/lstm_glass_anomaly.pth"))
model.eval()
...
async def main():
    ...
    async with Client(url=url) as client:
        ...
        write_tasks = [
            ...
            write_variable(client, "ns=4;s=AIO_PF1_Pressure", 0, ua.VariantType.Float),
            write_variable(client, "ns=4;s=AIO_PF1_Gas_Flow_Rate", 0, ua.VariantType.Float),
        ...
        with open(output_file, mode="a", newline="", encoding="utf-8") as csvfile:
            ...
            while True:
                ...
                selected_data = row_data[:, [4, 5, 6, 7]] # [Chamber_Pressure, Main_Gas_Flow_Rate, PF1_Pressure, PF1_Gas_Flow_Rate]

                # Assuming chamber_temp is always 1000
                chamber_temp = 1000

                # Actual Cold Spray Maching running
                selected_data = row_data[:, [3]]

                if chamber_temp == 1000:
                    ...
                    if len(data_queue) == 60:
                        ...
                        if hasattr(scaler, "data_min_") and hasattr(scaler, "data_max_"):
                            ...
                            write_tasks = [
                                ...
                                write_variable(client, "ns=4;s=AIO_PF1_Pressure", float(original_prediction[0, 2]), ua.VariantType.Float),
                                write_variable(client, "ns=4;s=AIO_PF1_Gas_Flow_Rate", float(original_prediction[0, 3]), ua.VariantType.Float),
